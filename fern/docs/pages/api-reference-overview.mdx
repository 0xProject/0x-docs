...
- **[Cross-Chain](/api-reference/0-x-api/cross-chain/cross-chain-get-quotes)**: Bridge assets between EVM, Solana, Tron, and HyperCore chains with ready-to-sign quotes and live status tracking.
