...
<Note>
  If you are unsure how to set this field, keeping it at zero or small as
  possible allows us to find the best swaps for you! It is better to find this
  number experimentally than set higher than needed
</Note>
