...
- **WSOL-Only for SOL:**\
  Only the wrapped SOL (WSOL) SPL token (`So11111111111111111111111111111111111111112`) is supported. Native SOL accounts (`So11111111111111111111111111111111111111111`) are explicitly rejected.
