...
- Solana is activating transaction format v1. Quotes you compile from this guide stay v0. If you call `getTransaction` or `getBlock`, pass `maxSupportedTransactionVersion: 1`. See [Solana transaction v1](/svm/solana-swap-api/guides/solana-transaction-v1).
