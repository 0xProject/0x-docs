...
In our example, we will be swapping USDT on Tron to USDC on Arbitrum. For understanding how to deal with the native TRX, please refer to [Native Tokens Handling](/cross-chain/cross-chain-api/key-concepts/native-tokens-handling).
