...
**Want to collect fees?** See [Monetize Your App](/docs/cross-chain-api/guides/monetize-your-app) for setup, including the [Solana-specific constraints](/docs/cross-chain-api/guides/monetize-your-app#solana-origin-constraints).
