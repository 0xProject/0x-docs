...
| `bridgeNativeFee` | Additional bridge infrastructure cost paid by the user in native tokens. Please see [Native Tokens and Bridge Fees](/cross-chain/cross-chain-api/key-concepts/understanding-bridging-costs) for details. |
