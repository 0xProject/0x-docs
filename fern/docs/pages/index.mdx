...
>
  <div style={{ flex: "1 1 340px" }}>
    ...
    <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
      <a
        href="/docs/overview/introduction/getting-started"
...
<Card title="EVM Swap API" href="/docs/0x-swap-api/introduction" icon="shuffle">
  Embed token swaps on any EVM chain. Aggregated liquidity from 150+ sources.
</Card>

<Card title="Solana Swap API" href="/docs/0x-swap-api/introduction" icon="sun">
...
<Card
  title="Support"
  href="/introduction/need-help#-contact-developer-support-fastest-direct-help"
  icon="life-ring"
>
