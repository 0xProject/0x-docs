...
For tokens that do not support gasless approvals, you need to set the token allowance via the steps listed [here](/docs/swap-api/additional-topics/handling-native-tokens).
