...
Handle every `approval.type` your integration can receive, including `erc7597Permit`. Any type your code does not recognize sends the user through a regular on-chain approval, which costs them gas.
