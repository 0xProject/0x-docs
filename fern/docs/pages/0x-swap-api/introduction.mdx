...
<Frame>
  <img src="https://0x.org/docs/assets/images/swap-api-ui-d28611dd5b85f518a34f7c0326f80034.png" alt="Swap API UI" />
</Frame>
...
- 🤑 **Built-in monetization**: [Earn fees](/docs/swap-api/guides/monetize-your-app) on every swap.
...
You’ll receive an unsigned Ethereum transaction that can be [signed and submitted](/docs/introduction/quickstart/swap-tokens-with-swap-api#4-submit-the-transaction) directly to a node.
Learn more about the response parameters in the [API docs](/api-reference/openapi-yaml/swap/allowanceholder-getprice).
...
<Frame>
  <img src="https://0x.org/docs/assets/images/swap-api-diagram-b557e01e96f8612c8da768aab6a0e1b6.png" alt="Swap API Diagram" />
</Frame>
<Steps>
  <Step>
  ...
  <Step>
    Swap API simultaneously (a) fetches a quote from AMM and (b) requests quotes from market makers.
  </Step>
  <Step>
    Market makers respond with signed quotes at their discretion.
  </Step>
  <Step>
    Swap API aggregates all quotes, compares them, and returns the best price.
  </Step>
  <Step>
    If the user accepts, the signed order is submitted on-chain and settled via 0x.
  </Step>
</Steps>
For more details about how 0x orders are executed, check out [How does 0x
work?](/docs/core-concepts/introduction-to-0-x#how-does-0x-work)
...
- The response returned by Swap API is a valid unsigned Ethereum transaction that can be signed and submitted directly to an Ethereum node. **[Easily execute using the transaction using the web3 library of your choice](/docs/swap-api/guides/swap-tokens-with-swap-api#3-send-the-transaction-to-the-network)**.
...
Next, [Get Started with Swap API](/docs/introduction/quickstart/swap-tokens-with-swap-api).
