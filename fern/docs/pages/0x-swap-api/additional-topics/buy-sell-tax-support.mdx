...
![Generic Swap Error](../../../assets/img/0x-swap-api/generic-swap-error.png)
...
![Matcha Buy Tax UI](../../../assets/img/0x-swap-api/matcha-buy-tax-ui.png)
...
![Matcha Buy Sell Tax UI](../../../assets/img/0x-swap-api/matcha-buy-sell-tax-ui.png)

</Accordion>

<Accordion title="Step 2: Utilize API Response Parameters">

Use the `tokenMetadata` object returned in the `/price` and `/quote` endpoints for both [Swap and Gasless API calls](/api-reference/evm-ap-is/swap/allowanceholder-getprice). This object contains the buy/sell tax information for the tokens involved in the swap.
...
![Matcha Transfer Fee Info](../../../assets/img/0x-swap-api/matcha-transfer-fee-info.png)
