...
## Steps for Handling Native Tokens[​](/docs/swap-api/additional-topics/handling-native-tokens#steps-for-handling-native-tokens "Direct link to Steps for Handling Native Tokens")
