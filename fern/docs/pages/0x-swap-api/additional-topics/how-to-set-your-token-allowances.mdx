...
| ------------------------------------------------------------------------------------- | ------------------------- |
| [`/swap/allowance-holder`](/api-reference/evm-ap-is/swap/allowanceholder-getquote) | AllowanceHolder           |
| [`/swap/permit2`](/api-reference/evm-ap-is/swap/permit-2-getquote)                 | Permit2                   |
...
![Etherscan approve method](../../../assets/img/0x-swap-api/etherscan-token-allowance.png)
