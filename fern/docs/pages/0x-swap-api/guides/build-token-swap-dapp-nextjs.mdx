...
PriceView displays indicative pricing using[/swap/allowance-holder/price](/api-reference/evm-ap-is/swap/allowanceholder-getprice). Indicative pricing is for users to browse for a price without committing to a trade.
...
QuoteView displays a firm, executable quote returned from [/swap/allowance-holder/quote](/api-reference/evm-ap-is/swap/allowanceholder-getquote).
