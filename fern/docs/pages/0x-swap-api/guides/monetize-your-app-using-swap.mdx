...
1. [Affiliate fees](/docs/swap-api/guides/monetize-your-app#option-1:-collect-affiliate-fees) (aka trading fee or commission) – Available on all pricing plans.
2. [Trade surplus](/docs/swap-api/guides/monetize-your-app#option-2:-collect-trade-surplus) (aka positive slippage) – Available to select integrators on custom plans. For assistance with setting up a custom plan, please [contact support](https://help.0x.org/en/articles/8230055-how-to-get-dev-support-from-the-0x-team).
