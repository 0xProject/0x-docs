...
Every 0x API call requires an API key. [Create a 0x account](https://dashboard.0x.org/) to get your live API key. Follow the [setup guide](/docs/introduction/quickstart/create-a-0-x-api-key) for more details.
...
const priceParams = new URLSearchParams({
  chainId: "1", // / Ethereum mainnet. See the 0x Cheat Sheet for all supported endpoints: https://0x.org/docs/core-concepts/0-x-cheat-sheet
...
For step-by-step instructions, see [how to set your token allowances](/docs/swap-api/guides/build-token-swap-d-app-next-js).
