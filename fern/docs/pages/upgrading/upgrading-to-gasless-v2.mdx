...
- new [buy/sell tax support](/docs/0x-swap-api/additional-topics/buy-sell-tax-support)
...
In v2, for [tokens that do not support gasless approvals](/api-reference/openapi-yaml/gasless/getgaslessapprovaltokens), use the [standard token approval flow](/docs/0x-swap-api/additional-topics/how-to-set-your-token-allowances).
