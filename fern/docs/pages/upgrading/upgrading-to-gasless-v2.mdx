...
- improved [monetization features](/evm/0x-swap-api/guides/monetize-your-app-using-swap)
...
- new [buy/sell tax support](/evm/0x-swap-api/additional-topics/buy-sell-tax-support)
