...
The AllowanceHolder contract is deployed at different addresses based on the chain’s latest supported EVM hardfork. You can find the most recent addresses in the [list of deployed addresses](https://0x.org/docs/core-concepts/0x-cheat-sheet#allowanceholder-address).
