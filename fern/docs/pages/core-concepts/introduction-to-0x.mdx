...
<Frame>
  <img src="https://0x.org/docs/assets/images/swap-widget-7538362651668891622d3cffb2ea5edf.png" alt="0x swap widget" />
</Frame>
...
- [Swap API](/docs/swap-api/introduction) - The most efficient liquidity aggregator for ERC20 tokens through a single API.
...
- [Trade Analytics API](/docs/swap-api/introduction) - Programatically access historical trades initiated through your apps via 0x Swap and Gasless APIs.

<Frame>
  <img src="https://0x.org/docs/assets/images/routing-fce4478b601d3246d22593f25f1e3827.png" alt="0x routing" />
</Frame>
...
<Frame>
  <img src="https://0x.org/docs/assets/images/0x-tech-stack-v2-b6789b1dcc674de32ceba05b4ac18339.png" alt="0x tech stack v2" />
</Frame>
...
<Frame>
  <img src="https://0x.org/docs/assets/images/onchainoffchain-52268508d5da884280e98f63efe34ad5.gif" alt="how does 0x work" />
</Frame>
<Steps>
