...
<Tip>
  ...
  Bits a second time. The `AllowanceHolder` contract has additionally been
  [formally
  verified](https://github.com/0xProject/0x-settler/blob/master/audits/Bailsec%20AllowanceHolder%20FV/Bailsec_0x_%E2%80%93_AllowanceHolder_%E2%80%93_Formal_Verification_1st_FV_Report.pdf).
</Tip>
