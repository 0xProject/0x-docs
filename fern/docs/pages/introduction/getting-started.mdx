...
![0x Dashboard Sign-up](../../assets/img/introduction/0x-dashboard-sign-up.png)
...
![0x Dashboard Create Team](../../assets/img/introduction/0x-dashboard-create-team.png)
...
![0x Dashboard Create App](../../assets/img/introduction/0x-dashboard-create-an-app.png)
...
![0x Dashboard Create an App](../../assets/img/introduction/0x-dashboard-create-app-screen.png)
...
![0x Dashboard Reval API Key](../../assets/img/introduction/0x-dashboard-copy-api-key.png)
...
This is a valid unsigned Ethereum transaction that can be [signed and submitted directly to a node](/docs/introduction/quickstart/swap-tokens-with-0x-swap-api#4-submit-the-transaction) to complete the swap. Read more about the parameters [here](https://0x.org/docs/api#tag/Swap).

To find a list of all networks supported by 0x, check out the [0x Cheat Sheet](https://0x.org/docs/core-concepts/0x-cheat-sheet).

## 4. Manage Your App

From the main dashboard screen, you can see all the apps you have created:

![0x Dashboard Home](../../assets/img/introduction/0x-dashboard-home.png)

Click on an App to open up details about its API request health:

![0x Dashboard Home](../../assets/img/introduction/0x-dashboard-demo-app-annotated.png)
...
![0x Dashboard Settings](../../assets/img/introduction/0x-dashboard-settings.png)
...
<Card
  title="Core Concepts"
  href="/docs/core-concepts/introduction-to-0x"
  icon="books"
>
