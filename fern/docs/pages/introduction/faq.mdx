...
<Accordion title="How do I find a list of supported chains for Swap?">
  Use the <a href="/api-reference/evm-ap-is/swap/chains">getChains</a>{" "}
...
<Accordion title="Is it possible to quote by the `buyAmount`?">
  ...
  the buy token you want to receive, and the API will calculate the required sell
  amount. See the <a href="/api-reference/evm-ap-is/swap/allowanceholder-getquote#request.query.buyAmount">API reference</a> for details.
</Accordion>
...
<Accordion title="How do I get a list of sources the API is sourcing from?">
  Use the{" "}
  <a href="/api-reference/evm-ap-is/sources/getsources">getSources</a>{" "}
  endpoint.
</Accordion>
...
<Accordion title="What if my user wants to sell a native token (e.g., swap ETH for USDC) on Mainnet?">
  Use the{" "}
  <a href="/api-reference/evm-ap-is/swap/allowanceholder-getprice">
    Swap API
  </a>{" "}
