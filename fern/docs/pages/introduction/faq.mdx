...
<Accordion title="Has the AllowanceHolder contract been formally verified?">
  ...
  covering 0x Settler, <code>AllowanceHolder</code> has been independently{" "}
  <strong>formally verified</strong> by Bailsec using the Certora Prover.
  Formal verification mathematically proves the contract satisfies a written
  specification across <em>every</em> reachable state and execution path,
  rather than only the paths that testing and fuzzing happen to explore.
  <br />
  <br />
  ...
  Read the full{" "}
  <a href="https://github.com/0xProject/0x-settler/blob/master/audits/Bailsec%20AllowanceHolder%20FV/Bailsec_0x_%E2%80%93_AllowanceHolder_%E2%80%93_Formal_Verification_1st_FV_Report.pdf">
    AllowanceHolder Formal Verification report
  </a>{" "}
  or browse the{" "}
  <a href="https://github.com/0xProject/0x-settler/tree/master/audits/Bailsec%20AllowanceHolder%20FV/certora">
    Certora specs
  </a>{" "}
  used to produce it.
</Accordion>
...
<AccordionGroup>
  <Accordion title="Are the smart contracts audited?">
    ...
    . The <code>AllowanceHolder</code> contract has additionally been{" "}
    <a href="https://github.com/0xProject/0x-settler/blob/master/audits/Bailsec%20AllowanceHolder%20FV/Bailsec_0x_%E2%80%93_AllowanceHolder_%E2%80%93_Formal_Verification_1st_FV_Report.pdf">
      formally verified
    </a>
    . Check out our{" "}
