...
<Accordion title="Has the AllowanceHolder contract been formally verified?">
  Yes. The <code>AllowanceHolder</code> contract has undergone multiple external <a href="https://github.com/0xProject/0x-settler/tree/master/audits">security audits</a> and <a href="https://github.com/0xProject/0x-settler/blob/master/audits/Bailsec%20AllowanceHolder%20FV/Bailsec_0x_%E2%80%93_AllowanceHolder_%E2%80%93_Formal_Verification_1st_FV_Report.pdf">formal verification</a>. Unlike testing and fuzzing, which only explore particular execution paths, formal verification mathematically proves the contract's properties hold across every reachable state and execution path.
</Accordion>
