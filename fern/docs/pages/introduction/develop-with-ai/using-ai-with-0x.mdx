...
<Card
  title="Trade from the terminal with the 0x CLI"
  href="/docs/introduction/develop-with-ai/0x-cli"
  icon="terminal"
>
...
<Card
  ...
  href="/docs/introduction/develop-with-ai/autonomous-agent-payments"
  icon="coins"
>
