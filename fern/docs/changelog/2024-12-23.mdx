...
- **Reminder**: version 1.0 of the API will be sunset on **April 11, 2025**. Please migrate to Version 2.0 before this date to avoid service disruptions. For more information, see the [Migration Guide](https://docs.0x.org/docs/upgrading/overview).
