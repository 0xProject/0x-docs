...
**TL;DR:**
0x has one “Feature Integration” bounty. We are offering 6 prizes to the best projects that use any one of 0x APIs - Swap, Gasless, Price. Read here for [judging criteria](/hackathons/ethdenver-guide#judging-criteria). Read here for [build resources & demo apps](/hackathons/ethdenver-guide#resources).
