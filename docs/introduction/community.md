...
As a first step in your troubleshooting, we recommend asking our AI-powered search (Ask Mendable) in the documentation search bar to help point you in the right direction. The search bar also provides standard keyword search.

![mendable search](/img/introduction/mendable-search.png)
