...
Price API provides access to real-time market prices for any token pair across 5 million tokens covering [9 different chains](/0x-price-api/#supported-networks). It allows you to get accurate pricing data with high throughput to power high-frequency data requests.
