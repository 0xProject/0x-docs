...
_Get real-time DEX prices for tokens pairs with Price API_

## What is Price API?

Price API provides access to real-time DEX prices for over 4 million tokens across [11 different chains](/0x-price-api/#supported-networks). It allows you to get accurate pricing data with high throughput to power high-frequency data requests.
