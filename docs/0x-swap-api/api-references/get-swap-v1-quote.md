...
| `excludedSources`                 | (Optional) Liquidity sources (`Uniswap`, `SushiSwap`, `0x`, `Curve`, etc) that will not be included in the provided quote. See [here](/0x-swap-api/api-references/get-swap-v1-sources) for a full list of sources.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | excludedSources=Uniswap,SushiSwap,Curve                             |
| `includedSources`                 | (Optional) For now only supports `RFQT`, which should be used when the integrator only wants RFQ liquidity without any other DEX orders, this is useful for [testing your RFQ integration](/0x-swap-api/guides/accessing-rfq-liquidity/how-to-integrate-rfq-liquidity#testing-your-rfq-integration-recommended). This parameter cannot be combined with `excludedSources`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | includedSources=RFQT                                                |
