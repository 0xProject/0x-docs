...
| `includedSources`                 | (Optional) When used, only the specified [liquidity sources](https://0x-docs-git-jlin-update-rfqt-0x-included-excludedsources-0x-eng.vercel.app/docs/0x-swap-api/api-references/get-swap-v1-sources) (`Uniswap`, `SushiSwap`, `0x`, `Curve`, etc) will be included in the provided quote. <br/><br/> One use case is for [testing your RFQ integration](/0x-swap-api/guides/accessing-rfq-liquidity/how-to-integrate-rfq-liquidity#testing-your-rfq-integration-recommended) by setting the value to `0x`. This should be used when the integrator only wants RFQ liquidity without any other DEX orders. <br/><br/> This parameter cannot be combined with `excludedSources`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | includedSources=0x                                                  |
...
| `intentOnFilling`                 | (Optional) Used to enable RFQ liquidity. For more details see the guide [here](/0x-swap-api/guides/accessing-rfq-liquidity/how-to-integrate-rfq-liquidity#2-firm-quotes) .                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | intentOnFilling=true                                                |
...
| `feeRecipientTradeSurplus`        | (Optional) The recipient of any trade surplus fees. If specified, this will collect trade surplus when applicable. Otherwise, trade surplus will not be collected.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | feeRecipientTradeSurplus=0xa8aac589a67ecfade31efde49a062cc21d68a64e |
...
RFQ liquidity can only be accessed if the request supplies a taker address, a permissioned API key via header `0x-api-key` (get one from the [0x Dashboard](https://dashboard.0x.org/)) and the query parameter `intentOnFilling=true`. For more details see the guide [here](/0x-swap-api/guides/accessing-rfq-liquidity/how-to-integrate-rfq-liquidity).
...
```
curl https://api.0x.org/swap/v1/quote?sellToken=WETH&buyToken=DAI&sellAmount=1000000000000000000&takerAddress=0xffffffffffffffffffffffffffffffffffffffff&intentOnFilling=true   --header '0x-api-key: <API_KEY>'
```
