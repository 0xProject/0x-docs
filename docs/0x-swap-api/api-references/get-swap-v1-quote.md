...
| `includedSources`                 | (Optional) For now only supports `0x`, which should be used when the integrator only wants RFQ liquidity without any other DEX orders, this is useful for [testing your RFQ integration](/0x-swap-api/guides/accessing-rfq-liquidity/how-to-integrate-rfq-liquidity#testing-your-rfq-integration-recommended). This parameter cannot be combined with `excludedSources`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | includedSources=0x                                                  |
