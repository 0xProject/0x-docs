---
sidebar_label: Build a token swap dApp
sidebar_position: 2
...
Learn how to build a token swapping DApp (a simple [Matcha.xyz](https://matcha.xyz/)) using the 0x [Swap API](/0x-swap-api/introduction) This dApp aggregates liquidity across the greater DEX ecosystem surfaces the best price to the user to the user.
