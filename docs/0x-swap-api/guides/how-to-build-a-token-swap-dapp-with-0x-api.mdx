...
:::warning
After May 8, 2023, all API requests without an API key will return an error. This example may contain requests without API keys. Follow [this guide](/introduction/getting-started) for how to get a live API key and use it for any 0x products. 
:::
...
- [Create a 0x account with a live API key](https://dashboard.0x.org/apps)
