...
_Easily enable crypto trading in your app with Swap API_

:::tip

Prefer to watch a video or see a code demo instead? Jump to [0x Videos](/introduction/guides#videos) or [0x Code Examples](/introduction/guides#code-examples).
...
Swap API allows you to add crypto trading in your application with just a single API integration. It finds the best real-time price across 100+ liquidity sources, both public (AMMs) and private (professional market makers), across [11 different chains](/0x-swap-api/introduction#supported-networks)
...
- ⛓️ Easily access **[multi-chain liquidity](/introduction/0x-cheat-sheet#swap-api-endpoints)** on the most popular networks
  - Ethereum, Sepolia, Polygon, Mumbai, BSC, Optimism, Fantom, Celo, Avalanche, Arbitrum, Base ([full list of endpoints](/introduction/0x-cheat-sheet#swap-api-endpoints))
- 🤑 **[Earn revenue fees](/developer-resources/faqs-and-troubleshooting#monetizing-your-swap-integration)** through your app's swap integration
...
- 💰 Exclusive built-in **[RFQ liquidity](/0x-swap-api/guides/accessing-rfq-liquidity-on-0x-api)** which is competetive with AMMs and comes with the added benefit of zero slippage and guarnteed MEV protection
...
curl https://api.0x.org/swap/v1/quote?buyToken=0x6B175474E89094C44Da98b954EedeAC495271d0F&sellToken=0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE&sellAmount=100000&excludedSources=Kyber&takerAddress=0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045  --header '0x-api-key: 35aa607c-1e98-4404-ad87-4bed10a538ae'
...
**Note:** This request uses a test API key that should not be used in production. Create an account and get your live API keys to access the Swap API from **[0x Dashboard](https://go.0x.org/create-account-txrelay-a)**.
...
Read more about using the [Swap API](/0x-swap-api/api-references/overview).

## Get Started

:::info
To create an account, and get your live API keys to access the Tx Relay, visit the **[0x Dashboard](https://go.0x.org/create-account-txrelay-a)**.
:::
...
- [Next.js 0x Demo App (TypeScript)](https://github.com/0xProject/0x-nextjs-demo-app)
