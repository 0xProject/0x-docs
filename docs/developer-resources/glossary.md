...
The 0x API helps users get the best price on their swap via Smart Order Routing splits a fill up up across the different sources to maximize the overall return on your swap. Checkout [this article ](https://medium.com/@merklejerk/0x-apis-smart-order-routing-7af0195515e5)for details on how it works.
